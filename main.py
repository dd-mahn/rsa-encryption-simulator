...
def home():
    if request.method == 'POST':
        ...
        return render_template('index.html',all_prime=all_prime, public_key=public, private_key=private, encrypted_msg=encrypted_msg, decrypted_msg=decrypted_msg, p = p, q = q, message = message)
